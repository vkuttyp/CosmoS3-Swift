...
#ifndef COSMOS3_SWIFT_H
#define COSMOS3_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CosmoS3",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7CosmoS311S3XmlParser")
@interface S3XmlParser : NSObject <NSXMLParserDelegate>
